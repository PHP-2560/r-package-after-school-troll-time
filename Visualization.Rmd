...
```{r}
histogram <- function(data, xvar, fill=NULL, group = NULL, binwidth=200, alpha=.5, position="identity"){
...
```{r}
histogram(mtcars, xvar = "disp", fill = "vs", position = "identity",  binwidth=100,group="vs")
```
